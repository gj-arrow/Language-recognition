...
namespace MyTask.DAL.Identity
{
        ...
        where TUser :IdentityUser
    {
        ...
        public int UpdateDateLastLogin(string email, DateTime date)
        {
            string commandText = @"Update AspNetUsers set DateLastLogin=@datelastlogin WHERE Email = @email";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("@datelastlogin", date);
